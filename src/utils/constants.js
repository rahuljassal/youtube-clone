...
export const GOOGLE_API_KEY = "AIzaSyD5cAH1KeGY1JxOEuESwUp2EsOcrxkcr_s";
// export const GOOGLE_API_KEY = process.env.GOOGLE_API_KEY;
// console.log("GOOGLE_API_KEY", process.env, import.meta, GOOGLE_API_KEY);
export const YOUTUBE_POPULAR_VIDEOS =
  " https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=50&regionCode=IN&key=" +
  GOOGLE_API_KEY;

export const YOUTUBE_SEARCH_API = `https://youtube-search-suggestion.onrender.com/?key=${GOOGLE_API_KEY}q=`;
